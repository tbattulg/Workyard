/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce5bd115ec01202a31f28eca6b71cee9)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'ENVIRONMENT' | 'PUBLIC_APP_NAME' | 'PUBLIC_APP_URL' | 'PILOT_MARKET' | 'ALLOW_DEMO_AUTH'
    >
  > {}
}
